...
class Camera_stream(QThread):
    ...
    def __init__(self, cap = None, parent = None, mode_detection = "", color = ""):
        ...
        self.detection_config = constant.mode_detection[mode_detection]
        self.color_config = constant.color_option[color]

        self.morse = Morse(self.color_config["threshold"])
        self.msg = Msg(self.detection_config)
        self.tracker = tracker.CentroidTracker(maxDisappeared=50, maxDistance=50)
        self.mode = "Tunggal"
...
class Morse():
    def __init__(self, thres):
        ...
        self.kernelSize = constant.shape_config["kernelSize"]
        self.kernel = cv2.getStructuringElement(cv2.MORPH_CROSS,(self.kernelSize,self.kernelSize))
        self.minSize = constant.shape_config["minSize"]
        self.maxSize = constant.shape_config["maxSize"]
